                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="app-brand justify-content-center mb-4 mt-2">
                                    <a href="http://localhost/full-version/public" class="app-brand-link gap-2">
                                ...
                                <form @submit.prevent="submitForm" >
                                    <div class="mb-3 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        ...
                                        <input type="text" v-model="username" class="form-control" id="email" name="email-username"
                                            placeholder="Enter your email or username" />
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                    <div
                                        class="mb-3 form-password-toggle fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="password">Password</label>
                                            <a href="http://localhost/full-version/public/auth/forgot-password-basic">
                                                <small>Forgot Password?</small>
                                            </a>
                                        </div>
                                        <div class="input-group input-group-merge has-validation">
                                            <input type="password" id="password" class="form-control" name="password"
                                                placeholder="············" aria-describedby="password" v-model="password" />
                                ...
                                <p class="text-center">
                                    ...
                                    <a href="http://localhost/full-version/public/auth/register-basic">
